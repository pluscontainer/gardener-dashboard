...
const getters = {
  ...
  initialWorkerByCloudProfileNameAndRegionAndZones (state, getters, rootState, rootGetters) {
    return ({ cloudProfileName, region, zones }) => getInitialWorker({ rootGetters }, { cloudProfileName, region, zones })
  },
